...
*/
/*
Copyright 2017  Sugar Maple Interactive, LLC  (email : support@reachapp.co)
...
function reach_get_sponsorships($atts) {
  ...
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#sponsorships-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#sponsorships-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_campaigns() {
  ...
  $reach_html.='<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#campaigns-iframe").iFrameResize({checkOrigin:false,scrollCallback:(0,0)});</script>';
  $reach_html.='<script>$("#campaigns-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_projects() {
  ...
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#projects-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#projects-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_places() {
  ...
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#places-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#places-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_project_page($atts) {
  ...
  $reach_html = "<iframe id='projects-iframe' src='https://".str_replace($search, '', $reach_api_host)."/projects/".$atts['permalink']."?disablenav=true' width='100%' scrolling='no' frameborder='0'></iframe>";
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#projects-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#projects-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
...
function reach_get_place_page($atts) {
  ...
  $reach_html = "<iframe id='places-iframe' src='https://".str_replace($search, '', $reach_api_host)."/places/".$atts['permalink']."?disablenav=true' width='100%' scrolling='no' frameborder='0'></iframe>";
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#places-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#places-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
...
function reach_get_campaign_page($atts) {
  ...
  $reach_html = "<iframe id='campaigns-iframe' src='https://".str_replace($search, '', $reach_api_host)."/campaigns/".$atts['permalink']."?disablenav=true' width='100%' scrolling='no' frameborder='0'></iframe>";
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#campaigns-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#campaigns-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_donation_page($atts) {
  ...
  $reach_html = "<iframe id='donations-iframe' src='https://".str_replace($search, '', $reach_api_host)."/donations/new?".http_build_query($atts)."' width='100%' scrolling='no' frameborder='0'></iframe>";
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#donations-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#donations-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_custom_form($atts) {
  ...
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.="<script>$('#custom-form-".$atts['permalink']."-iframe').iFrameResize({checkOrigin:false});</script>";
  $reach_html.="<script>$('#custom-form-".$atts['permalink']."-iframe').on('load', function () {parent.scrollTo(0,0)});</script>";
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_products() {
  ...
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#products-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#products-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_events() {
  ...
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#events-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#events-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_calendar_page() {
  ...
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#calendar-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#calendar-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_event_page($atts) {
  ...
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.="<script>$('#event-".$atts['permalink']."-iframe').iFrameResize({checkOrigin:false});</script>";
  $reach_html.="<script>$('#event-".$atts['permalink']."-iframe').on('load', function () {parent.scrollTo(0,0)});</script>";
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
...
function reach_get_supporter_page($atts) {
  ...
  $reach_html.='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>';
  $reach_html.="<script type='text/javascript' src='https://".str_replace($search, '', $reach_api_host)."/assets/iframeResizer.min.js'></script>";
  $reach_html.='<script>$("#supporter-iframe").iFrameResize({checkOrigin:false});</script>';
  $reach_html.='<script>$("#supporter-iframe").on("load", function () {parent.scrollTo(0,0)});</script>';
  $reach_html.="<script type='text/javascript' src='".plugins_url()."/reach-connector/iframeResizer.contentWindow.min.js'></script>";
