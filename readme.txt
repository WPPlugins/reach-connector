...
Tags: reach, connector, campaign, charity, child, sponsorships, fundraising, donate, sugar, maple, interactive, donor management, custom forms, events, event management, calendar
...
= 1.8 =
* Bug fix when plugin content was being displayed above text on the page.

= 1.9 =
* Update for displaying https assets for campaigns.

= 2.0 =
* Display custom forms from REACH in your WordPress site.

= 2.1 =
* Display events and products from REACH in your WordPress site.

= 2.2 =
* Display supporter login page and embed menu from REACH in your WordPress site.

= 2.3 =
* Test under WordPress 4.8.
...
Custom Form Shortcode Setup

To pull a specific custom form from REACH® to display on your site use the shortcode with the permalink shown in REACH® [custom_form permalink='my-form-permalink'].
...
Products Shortcode Setup

To pull a list of products from REACH® to display on your site use the shortcode [products].
Events Shortcode Setup

To pull a list of events from REACH® to display on your site use the shortcode [events].
Calendar Shortcode Setup

To display a calendar of events from REACH® on your site use the shortcode [calendar].
Event Page Shortcode Setup

To pull a specific event from REACH® to display on your site use the shortcode with the permalink shown in REACH® [event permalink='my-place-permalink'].
Supporter Login Shortcode Setup

To display a login page for supporters from REACH® on your site use the shortcode [supporter_login].